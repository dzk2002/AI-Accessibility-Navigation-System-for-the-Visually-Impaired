...
def periodic_task(pic_dir, distance_file):
    while True:
        ...
        fetch_image_and_distance(pic_dir,distance_file)
        ...
        if globals.should_recognize_image:
            ...
            message = f'Distance: {distance_cm} cm, Keywords: {", ".join(keywords)}'
...
if __name__ == '__main__':
    ...
    thread = Thread(target=periodic_task, args=(pic_dir, distance_file))
    thread.daemon = True
    thread.start()
